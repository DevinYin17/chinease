<div class="jobdetail-wrapper">
  ...
  <div class="content container">
    <div class="left">
      <div class="title">Easdasd Aasdasd</div>
      <div class="info line">2018/1/1 werwer</div>
      <div class="label"></div>

      <div class="basic-list">
        <div class="basic-item xl">
          <div class="basic-title">Job title:</div>
          <div class="basic-info">asdasd asd ads asd</div>
        </div>

        <div class="basic-item l">
          <div class="basic-title">Work type:</div>
          <div class="basic-info">asdasdasd asd asd a</div>
        </div>

        <div class="basic-item xl">
          <div class="basic-title">Age group:</div>
          <div class="basic-info">asdasdads,asdasda,asdasd
          asdas,d,d,d,d</div>
        </div>

        <div class="basic-item l">
          <div class="basic-title">Location:</div>
          <div class="basic-info">shanghao jiangsu</div>
        </div>
      </div>
      ...
      <div class="info line">
        qweq qweqwe
        qweqwe qweqwe
        qweqwecqweqwe qweqweqwe qweqwecqweqwe
        qwe
      </div>
